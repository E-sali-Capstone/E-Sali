    ...
    @include ('dashboard.forum.category.partials.inputs.color')

    @slot('actions')
        <button type="submit" class="btn btn-primary pull-right btn-rounded">{{ trans('forum::general.create') }}</button>
    @endslot
@endcomponent
